...
exit:
	...
	if (Display_Info) {
		auto msg = ret ? Msg(msg::kHighlight, "disable_avb2_success_msg=Disable AVB 2.0: processing '{1}' successfully.")(File_Name)
						: Msg(msg::kError, "disable_avb2_fail_msg=Disable AVB 2.0: processing '{1}' failed!")(File_Name);
		gui_msg(msg);
	}
	return ret;
}
